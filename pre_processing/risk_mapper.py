"""
Module for getting 'exposed' and 'unexposed' categories for GBD risks.
Written by Nathaniel Blair-Stahn in Apr-May, 2019 for the Neonatal ("Mom food") project,
copying some code from the LBWSG risk component.

Copied to vivarium_data_analysis repo as example code, not necessarily to be used for anything.
"""
