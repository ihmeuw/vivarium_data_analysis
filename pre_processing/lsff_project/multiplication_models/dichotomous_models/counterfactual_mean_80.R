...
setwd("H:/notebooks/vivarium_data_analysis/pre_processing/lsff_project/multiplication_models/dichotomous_models")
getwd()
# LOAD BASELINE DATA
mean <- read_excel("counterfactual_mean_80.xlsx")
sd <- read_excel("counterfactual_sd.xlsx")
...
fwrite(df, "counterfactual_anemia_prev_80.csv")
