...
def default_column_categories_to_search_regexes():
    return {
        ...
        'input_draw': r'input_draw',
        'random_seed': r'random_seed',
        'location': r'location', # any column containing the string 'location'
        'intervention': r'\w+\.\w+', # columns look like 'intervention_name.paramater'. Parameters determine scenario.
